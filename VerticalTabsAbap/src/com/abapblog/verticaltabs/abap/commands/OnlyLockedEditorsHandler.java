...
public class OnlyLockedEditorsHandler implements IHandler {

	private static final IPreferenceStore preferenceStore = Activator.getDefault().getPreferenceStore();
	public static final String ID = "com.abapblog.verticaltabs.commands.onlyLockedEditors";
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Boolean showOnlyLockedEditors = (((ToolItem) e.widget).getSelection());
		if (showOnlyLockedEditors) {
			preferenceStore.setValue(PreferenceConstants.SHOW_ONLY_LOCKED_EDITORS, true);
		} else {
			preferenceStore.setValue(PreferenceConstants.SHOW_ONLY_LOCKED_EDITORS, false);
		}
		setToggleStatus(showOnlyLockedEditors);
